...
tags:
thumbnail: "https://s2.ax1x.com/2020/02/16/3pbu9J.jpg"
---

暑研的每天碎碎念记录（讲道理窝自己回来看也看不懂自己记的是啥。。。

虽然是不太可能再来了但是还是很高兴可以自己一只喵登登登地去匹茨堡在cmu待上一个暑假叭

要一直向着云走呀

![3pbeNF.jpg](https://s2.ax1x.com/2020/02/16/3pbeNF.jpg)
...
早上安慰了一波Patricia搞得她热泪盈眶然后想叫Hai天天接送窝肥家了？
...
这个破电脑又自己关机。。。然后再次打开这个文件就是三天之后了？也不记得是没写还是写了没存，枯了，窝要买小水果！
...
晚上mentor把窝的target搞进去惹x抢我commit嘤嘤嘤

不过如果我加的确加不了searchBar。。。qvq
...
回顾了一哈mentor的聊天记录感觉用语言传达想法的却太难了、、、qvq
...
佛了就不能写在文档里吗QAQ，截的图和写的栗子不一样x面向自己想要的栗子截图：）
...
晚上waterfront肥来又zoom，然后解释窝的逻辑ing。
...
改了小写没改全让我fix。。。表演一个喵fix好叭

然后发现他原来一直不知道存储应该是一层的。。。上回窝commit的居然merge没了！现在还问uploader name咋不能命中。。。再喵fix好叭

然后就写discretize呗，还map。。。啥map啊
...
什么迷惑行为啊。。。spd同个field前后脚输出的居然和spd不对上？？？
...
![3pbZAU.jpg](https://s2.ax1x.com/2020/02/16/3pbZAU.jpg)
